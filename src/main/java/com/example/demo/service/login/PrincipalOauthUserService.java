...
import com.example.demo.vo.KakaoUserInfo;
import com.example.demo.vo.NaverUserInfo;
import com.example.demo.vo.OAuth2UserInfo;
...
public class PrincipalOauthUserService extends DefaultOAuth2UserService {
    ...
    //oauth 부터 받은 userRequest 데이터에 대한 후처리되는 함수
    //함수 종료시 @AuthenticationPrincipal 어노테이션이 만들어진다.
    @Override
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {

        //"registraionId" 로 어떤 OAuth 로 로그인 했는지 확인 가능(kakao,naver)
